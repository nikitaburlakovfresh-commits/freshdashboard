...
export const METRICS = {
  ...
  // Оборачиваемость склада: прогноз продаж итогом к складу на 1 число месяца.
  // Ячейки в источнике нет — показатель расчётный и как факт не публикуется.
  stockTurnover: { name: 'Оборачиваемость склада', unit: 'PCT', count: false, additive: false },
