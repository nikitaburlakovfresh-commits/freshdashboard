...
const adminGroups: NavGroup[] = [
  ...
  { label: 'Служебное', links: [
    ...
    // «Продажи и склад», «KPI и MBO», «БДР» убраны из меню намеренно. Это были
    // навигационные каркасы со страницей «Данные не подключены», оставшиеся от
    // первой карты модулей. Пока МБО разрабатывается по-настоящему, пункт меню
    // с тем же названием вводит в заблуждение: владелец справедливо спросил,
    // зачем этот блок, если МБО мы делаем. Страницы никуда не делись и открываются
    // по прямому адресу; ссылка вернётся, когда за ней будет работающий раздел.
    // Карта модулей осталась: она честно называет себя картой будущих контуров.
  ] },
];
