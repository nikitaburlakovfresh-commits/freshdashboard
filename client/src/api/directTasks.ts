...
export const getAssignOptions = () => apiFetch<{ scopes: AssignScope[] }>('/work-items/assign-options');
export const createDirectTask = (body: {
  kind: 'TASK' | 'UK_REQUEST'; org_unit_id: string; assignee_user_id: string; role_code?: string;
